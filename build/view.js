...
const SHORT_NAME_ADDRESS_COMPONENT_TYPES = new Set(['street_number', 'administrative_area_level_1', 'postal_code', 'country']);
...
function fillInAddress(place) {
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.dispatch)('wc/store/cart').setShippingAddress(newShippingAddress);
}
